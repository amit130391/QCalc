...
public class StandardCalculatorTest {
    ...
    void testMultiplicationOperationForDoubles(){
        standardCalculator.multiply(10.0,11.0);
        double actualResult = standardCalculator.getResult();
        Assertions.assertEquals(110.0, actualResult);
    }

    @Test
    @DisplayName("Test Division of Two Doubles")
    void testDivisionOperationForDoubles(){
        standardCalculator.divide(210.0,10.0);
        double actualResult = standardCalculator.getResult();
        Assertions.assertEquals(21.0, actualResult);
    }
    ...
    void testMultiplicationOperation(){
        standardCalculator.multiply(4, 5);
        double actualResult=standardCalculator.getResult();
    ...
    void testDivisionOperation(){
        standardCalculator.divide(20, 5);
        double actualResult=standardCalculator.getResult();
